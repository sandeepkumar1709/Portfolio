...
export const projects: ProjectDetail[] = [
  ...
  },
  {
    ...
    oneLiner: "RAG pipeline over academic PDFs with LangGraph orchestration, MCP web search, and dual LLM provider support. Rebuilt from an earlier local-only version that could not route or fall back.",

...
Before that I spent two and a half years at Infosys on a knowledge graph platform for a Fortune 500 financial services client. We integrated LLMs so it could translate natural English questions into Cypher queries, which made complex graph data usable by people who don't write queries, and lifted NLU accuracy from 85% to 92%.
